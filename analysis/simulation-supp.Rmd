---
title: "Simulation results from the supplement I (small-scale simulation)"
...
Below I compute the barplots of Supplementary Figures S4--S8.
...
Below I compute the false discovery curves of Supplementary Figures S4--S8.
...
Below is the code chunk used to generate Supplementary Figure S9.
...
foo <- function(x,lib,type,ylab,title = NULL,base_size = bs,legend = TRUE,...){
  ...
  p <- ggplot(data = sub.x, aes(x = Method,y = Value,group = interaction(nFDR_char,Quantifier))) +
    ...
    scale_color_manual(values = c('Bootstrap (kallisto)' = 'green3','Bootstrap (Salmon)' = 'red','Gibbs (Salmon)' = 'blue')) +
    scale_fill_manual(values = c('Bootstrap (kallisto)' = 'green3','Bootstrap (Salmon)' = 'red','Gibbs (Salmon)' = 'blue'),guide = "none") +
...
Below I generate Supplementary Table S1.
...
And finally all files are exported to be incorporated in the supplement.
